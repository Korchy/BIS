...
class BISAddNodeToStorage(Operator):
    ...
    def execute(self, context):
        if context.active_node and context.active_node.type == 'GROUP':
            ...
            node_group_tags += (';' if node_group_tags else '') + context.window.scene.render.engine
            ...
            if node_group_in_json:
                ...
                if context.window_manager.bis_add_nodegroup_to_storage_vars.tags != '':
                    node_group_tags += (';' if node_group_tags else '') + context.window_manager.bis_add_nodegroup_to_storage_vars.tags
